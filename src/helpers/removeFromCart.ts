...
export function removeSubprodFromCart(subprod: SubproductDto, cart: DocumentData): DocumentData {
  const updatedProds = cart.products.filter((elem: SubproductDto) => elem.id !== subprod.id)
